...
public class UdpActivity extends AppCompatActivity implements OnReceivedData {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((AppCompatActivity)this).getSupportActionBar().setTitle("UDP");
        ...
        connectB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                UdpServer rc = null;
                try {
                    rc = new UdpServer(serverIP, mPort, UdpActivity.this);
        ...
        connectToServerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new UdpActivity.TestAsync().execute();
        ...
        sendMsgToServerB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new UdpActivity.TestAsync2(msg).execute();
    ...
    class TestAsync extends AsyncTask<Void, Integer, String> {
        ...
        protected String doInBackground(Void... arg0) {
            try {
                ...
                try {
                    udpClient = new UdpClient(inetAddresses, mPort);
